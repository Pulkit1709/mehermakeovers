      ...
      <div className="luxury-container relative">
        ...
        >
          ...
          <p className="max-w-2xl text-base leading-8 text-muted-foreground lg:justify-self-end">
            Every appointment begins with a consultation, then moves through
            detail-led technique, luxury products, and a finish planned for
            real life, photography, and long-wear comfort.
          </p>
        </motion.div>
            ...
            >
              ...
              <div className="p-6 sm:p-7">
                <div className="flex items-start justify-between gap-4">
                  <h3 className="serif text-3xl leading-none text-foreground">
                    {service.title}
                  </h3>
                ...
                <motion.a
                  ...
                  whileTap={{ scale: 0.98 }}
                  href={whatsappLink(
                    `Hi, I am interested in ${service.title}. Can you help me book?`
                  )}
                  target="_blank"
                  rel="noreferrer"
