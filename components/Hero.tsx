    ...
    <section id="home" className="relative min-h-[100svh] overflow-hidden bg-background pt-24">
      ...
      <div className="luxury-container relative grid min-h-[calc(100svh-6rem)] items-center gap-12 pb-16 lg:grid-cols-[0.94fr_1.06fr]">
        ...
        >
          ...
          <motion.h1 variants={itemVariants} className="serif text-balance text-6xl font-semibold leading-[0.88] tracking-normal text-foreground sm:text-7xl lg:text-8xl">
            <motion.span
          ...
          <motion.p variants={itemVariants} className="mt-7 max-w-2xl text-base leading-8 text-muted-foreground sm:text-lg">
            {brand.name} creates bridal, hair, skin, nail, and occasion looks with quiet precision, premium products, and a private salon atmosphere.
          </motion.p>
          ...
          <motion.div variants={itemVariants} className="mt-10 flex flex-col gap-4 sm:flex-row">
            <motion.a
              whileHover={{ y: -4 }}
              whileTap={{ y: 0 }}
              href={whatsappLink('Hi, I want to book an appointment at Meher Makeover.')}
              target="_blank"
              rel="noreferrer"
          ...
          <motion.div variants={itemVariants} className="mt-12 grid max-w-xl grid-cols-3 border-y border-white/10">
            {stats.map((stat, index) => (
              ...
              >
                <div className="serif text-3xl text-primary sm:text-4xl transition duration-300 group-hover:scale-110">
                  {stat.value}
                </div>
        ...
        >
          ...
          <div className="relative h-full min-h-[520px] overflow-hidden border border-white/10 bg-card">
            <Image
              ...
              alt="Luxury salon interior at Meher Makeover in Agra"
              fill
              priority
            ...
            >
              <p className="text-xs uppercase tracking-[0.28em] text-primary">Signature experience</p>
              <p className="mt-3 text-sm leading-6 text-foreground/82">
                Private consultations, bespoke finish plans, and camera-conscious artistry for every event.
              </p>
            </motion.div>
          </div>
        </motion.div>
      ...
      >
        <motion.span animate={{ y: [0, 12, 0] }} transition={{ duration: 2, repeat: Infinity }} className="block">
